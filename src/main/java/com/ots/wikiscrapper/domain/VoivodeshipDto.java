...
/** Language-resolved representation of a {@link Voivodeship} for the API and list views. */
public record VoivodeshipDto(
    ...
    public static VoivodeshipDto from(Voivodeship entity, WikiLanguage language) {
    ...
    /** Description truncated for card previews. */
